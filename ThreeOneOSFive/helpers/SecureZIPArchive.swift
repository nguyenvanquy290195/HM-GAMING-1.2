...
enum SecureZIPArchiveError: Error, Equatable {
...
enum SecureZIPArchive {
    ...
    static func extract(
        ...
        guard archiveURL.isFileURL,
            ...
            throw SecureZIPArchiveError.unsupportedPackage
        }
        ...
        guard archiveValues.isRegularFile == true,
            ...
            throw SecureZIPArchiveError.symbolicLinkUnsupported
        }
        let archiveSize = Int64(archiveValues.fileSize ?? 0)
        guard archiveSize >= 22,
              archiveSize <= SecureZIPArchiveLimits.maximumArchiveBytes else {
            throw SecureZIPArchiveError.packageTooLarge
        }
        guard !fileManager.fileExists(atPath: destinationURL.path) else {
            throw SecureZIPArchiveError.unsafeArchive
        }
        ...
        guard entries.count <= SecureZIPArchiveLimits.maximumEntryCount,
              expandedBytes <= UInt64(SecureZIPArchiveLimits.maximumExpandedBytes) else {
            throw SecureZIPArchiveError.packageTooLarge
        }
        ...
        do {
            ...
            for entry in entries {
                ...
                guard status == 0 else { throw SecureZIPArchiveError.unsafeArchive }
            }
        } catch let error as SecureZIPArchiveError {
    ...
    private static func readEntries(
        ...
        guard diskNumber == 0,
              ...
              Int(entryCount) <= SecureZIPArchiveLimits.maximumEntryCount,
        ...
        for _ in 0..<Int(entryCount) {
            ...
            guard nameLength > 0,
                  nameLength <= SecureZIPArchiveLimits.maximumPathBytes,
                  ...
                  UInt64(uncompressedSize) <= UInt64(SecureZIPArchiveLimits.maximumEntryBytes) else {
                throw SecureZIPArchiveError.unsafeArchive
            }
            ...
            guard totalExpanded <= UInt64(SecureZIPArchiveLimits.maximumExpandedBytes) else {
                throw SecureZIPArchiveError.packageTooLarge
            }
        ...
        guard cursor == centralEnd else { throw SecureZIPArchiveError.unsafeArchive }
        return entries
    }
    ...
    private static func safeComponents(
        ...
        guard !rawName.isEmpty,
              ...
              rawName.utf8.count <= SecureZIPArchiveLimits.maximumPathBytes else {
            throw SecureZIPArchiveError.unsafeArchive
        }
    ...
    private static func destination(
        ...
        guard isContained(result, in: root) else {
            throw SecureZIPArchiveError.unsafeArchive
        }
        return result
    }
    ...
    private static func read(
        ...
        guard count >= 0 else { throw SecureZIPArchiveError.unsafeArchive }
